...
pm2 start venv/bin/python --name terhi-bot -- app.py
...
echo "✅ Setup complete. Your Flask application 'terhi-bot' should be running on port 8080 and managed by PM2."
...
echo "🪵 View logs with: pm2 logs terhi-bot"