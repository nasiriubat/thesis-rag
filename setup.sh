...
pm2 start venv/bin/python --name demo-thesis-rag -- app.py
...
echo "✅ Setup complete. Your Flask application 'demo-thesis-rag' should be running on port 8080 and managed by PM2."
...
echo "🪵 View logs with: pm2 logs demo-thesis-rag"